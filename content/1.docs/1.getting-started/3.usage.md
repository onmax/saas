...
Authentication is implemented with [Better Auth](https://better-auth.com) via [`@onmax/nuxt-better-auth`](https://better-auth.onmax.me), with [NuxtHub](https://hub.nuxt.com/) for database/KV and [Polar](https://polar.sh/) for billing.

See the [Authentication docs](/docs/authentication) for configuration, plugins, and webhooks.
